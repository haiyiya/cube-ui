...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  exports.default = {
    ...
    methods: {
      ...
      setloadIndex: function setloadIndex(currentPageIndex) {
        console.log(currentPageIndex);
        var addIndices = [];
        if (this.loop) {
          addIndices = [currentPageIndex > 0 ? currentPageIndex - 1 : this.imgEx.length - 1, currentPageIndex, currentPageIndex < this.imgEx.length - 1 ? currentPageIndex + 1 : 0];
        } else {
  ...
  return _c('transition', {
    ...
    return _c('cube-slide-item', {
      ...
      directives: [{
        name: "show",
        rawName: "v-show",
        value: (imgEx.isLoaded),
        expression: "imgEx.isLoaded"
      }],
      staticClass: "cube-image-preview-img",
      attrs: {
        "src": _vm.loadIndices.indexOf(index) > -1 ? imgEx.url : ''
      },
      on: {
        "load": function($event) {
